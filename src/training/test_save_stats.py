...
def main_test(dataloaders, phase, field, tokenizer, model_type, csv_path, 
    ...
    from utils.utils import load_model, load_trained_model, classif_report
    from train_utils import test_model, test_model_and_save_stats
    print()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_path", help="path to trained model", default='saved-models/HybridCNNLSTM_2024-04-28_18-12-59_trained_testAcc=0.6217.pth')
    ...
    parser.add_argument("--data_type", default='en')
